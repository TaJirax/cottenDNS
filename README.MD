...
| 🔐 Key/method policy varies per client | Server auto-detects keyed client encryption methods without silently enabling unkeyed method 0; client IPs and resolver paths may change without allowlists |
