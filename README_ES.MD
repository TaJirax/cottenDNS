...
Después de un escaneo completo exitoso, cambia `STARTUP_MODE` a `"logs"` para reutilizar resultados validados mientras las comprobaciones en segundo plano mantienen actualizado el pool.
