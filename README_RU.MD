...
После одного полного успешного сканирования переключите `STARTUP_MODE = "logs"`: проверенные результаты ускорят запуск, а фоновые проверки продолжат обновлять пул.
